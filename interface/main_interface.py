...
class MainWindow(QWidget):
    ...
    def registrar_venda(self):
        ...
        for row in range(self.ui.tableWidget.rowCount()):
            ...
            self.cursor.execute("""
                INSERT INTO registro_venda (qtd, cod_venda, codigo, produto, cliente, forma_pagamento, data_venda, valor_total_unit, subtotal_produt, desconto, valor_total, valor_pago, troco)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            """, (qtd, cod_venda, codigo, produto, cliente, forma_pagamento, data_venda, valor_total_unit, subtotal_produt, desconto, valor_total, valor_pago, troco))
    ...
    def exibir_registros_venda(self):
        self.cursor.execute("""
            SELECT qtd, cod_venda, codigo, produto, cliente, forma_pagamento, data_venda, Valor_total_unit, subtotal_produt, desconto, valor_total, valor_pago, troco 
            FROM registro_venda
        """)
        ...
        self.ui.tableWidget_2.setHorizontalHeaderLabels([
            "Qtd", "Cod_venda", "Código", "Produto", "Cliente", "Forma de Pagamento", 
